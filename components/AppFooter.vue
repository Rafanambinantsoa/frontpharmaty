            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 gap-y-10">
                <div class="col-span-2 md:col-span-4 lg:col-span-2">
                    <NuxtLink to="/" class=" flex items-center gap-2">
                        ...
                        <span class="text-xl font-bold text-gray-700 dark:text-white">EventPass </span>
                    </NuxtLink>
                    ...
                    <p class="text-gray-600 dark:text-gray-300 pt-6">
                        ...
                        Concerts, sports, festivals et bien plus encore, tout à portée de main. Ne passez pas à côté !
                ...
                <BlocksFooterNavBlock title="Support Us" :links="supportLinks" />
                <BlocksFooterNavBlock title="Support Links" :links="quickLinks" />
            </div>
        </AtomsContainer>
...
const supportLinks = [
    ...
    {
        href: "https://www.facebook.com/tsukasa.zeldris",
        text: "Facebook"
    },
    {
        href: "https://www.instagram.com/akutagawa_karim",
        text: "Instagram"
    },
    {
        href: "https://www.linkedin.com/in/rafanambinantsoa-kim-5a5508279/",
        text: "Linkedin"
    }
]
