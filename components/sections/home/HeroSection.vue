            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <span class="px-2 py-1 rounded-md bg-gray-100 dark:bg-body text-primary ">Ne ratez pas la nouvelle
                            vague d'événements captivants.</span>
                        <h1 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            "Trouvez et achetez<br> <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]"> vos
                                billets</span>
                            pour des expériences inoubliables, dès maintenant !"
                        </h1>
                    </div>

                    <p class="text-gray-600 dark:text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Découvrez et réservez des billets pour des événements passionnants sur notre plateforme en ligne.
                        Concerts, sports, festivals et bien plus encore, tout à portée de main. Ne manquez pas cette
                        opportunité ! Réservez votre place dès maintenant.
                    </p>
                ...
                <div class="lg:h-full  hidden md:flex">
                    ...
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div
                            ...
                            <img src="/images/font1.jpg" alt="In studio" width="500" height="auto" loading="lazy"
                        ...
                        <div
                            ...
                            <img src="/images/font2.jpg" alt="Happy in studio" width="200" height="auto" loading="lazy"
                                class="w-full h-full rounded-2xl object-cover">
                        </div>
                    </div>
                </div>
