<template>
    <section id="why" class="pt-20 md:pt-24">
        <AtomsContainer>
            <div class="grid md:grid-cols-2 gap-10 xl:gap-14 relative">
                <div class="md:py-2 lg:py-4 relative">
                    ...
                    <div class="relative">
                        <AtomsTitle texte="Découvrez ce qui nous distingue des autres." />
                        ...
                        <div class="space-y-4 pt-8">
                            <div
                                ...
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">Sélection d'Événements
                                    Diversifiée
                                </h3>
                                <p class="text-base text-gray-600 dark:text-gray-300">Découvrez une gamme variée
                                    d'événements adaptés à tous les goûts. Des concerts et du sport aux festivals et aux
                                    représentations théâtrales, trouvez l'événement parfait pour créer des souvenirs
                                    durables.</p>
                            </div>
                            <div
                                class="p-4 rounded-xl border border-box-border transition hover:bg-gray-200 dark:hover:bg-box-bg">
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">Transactions Sécurisées
                                </h3>
                                <p class="text-base text-gray-600 dark:text-gray-300">"Votre tranquillité d'esprit compte.
                                    Profitez de transactions sécurisées grâce à un cryptage avancé et à des mesures de
                                    confidentialité, garantissant la protection de vos données et de vos achats de billets."
                                </p>
                            </div>
                            <div
                                class="p-4 rounded-xl border border-box-border transition hover:bg-gray-200 dark:hover:bg-box-bg">
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">Une Communauté
                                    Technologique Engagée
                                </h3>
                                <p class="text-base text-gray-600 dark:text-gray-300">Rejoignez notre communauté
                                    technologique dynamique de passionnés d'événements. Connectez-vous, partagez des
                                    recommandations et restez informé des derniers événements pour une expérience
                                    enrichissante.</p>
                            </div>
                        </div>
                ...
                <div class="flex md:h-full relative">
                    ...
                    <div class="w-full h-[27rem] sm:h-[30rem] md:h-full flex justify-start md:justify-end relative pb-5">
                        <img src="/images/podCast.webp" alt="Podcast image" width="300"
